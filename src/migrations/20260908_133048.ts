...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  await db.execute(sql`
   CREATE TYPE "public"."enum_applications_role" AS ENUM('Creator', 'Channel Owner', 'Producer', 'Creative Director', 'Brand', 'Agency', 'Other');
  CREATE TYPE "public"."enum_applications_service" AS ENUM('Consulting', 'Ideation', 'Thumbnail Design', 'Full Packaging', 'Other');
  CREATE TYPE "public"."enum_applications_budget" AS ENUM('Under $250', '$250–$500', '$500–$1,000', '$1,000–$2,500', '$2,500+');
  CREATE TYPE "public"."enum_applications_status" AS ENUM('New', 'Reviewing', 'Accepted', 'Rejected', 'Archived');
  ...
  CREATE TABLE "applications" (
  	...
  	"role" "enum_applications_role" NOT NULL,
  	"youtube_channel" varchar NOT NULL,
  	"service" "enum_applications_service" NOT NULL,
  	"project_description" varchar NOT NULL,
  	"monthly_video_volume" varchar,
  	"budget" "enum_applications_budget",
  	"desired_start_date" timestamp(3) with time zone,
  ...
  CREATE TABLE "site_settings" (
  	"id" serial PRIMARY KEY NOT NULL,
  	"site_name" varchar DEFAULT '[YOUR NAME] — Thumbnail Designer',
  	"logo_id" integer,
  	"hero_image_id" integer,
  	"hero_heading" varchar DEFAULT 'I turn strong YouTube ideas into thumbnails people need to click.',
  	"hero_description" varchar DEFAULT 'Strategic thumbnail design for creators and brands who want their videos packaged with more clarity, curiosity and intent.',
  	"availability_label" varchar DEFAULT 'Available for selected projects',
  	"primary_cta_text" varchar DEFAULT 'Work With Me',
  	"secondary_cta_text" varchar DEFAULT 'View My Work',
  	"email_address" varchar DEFAULT 'hello@example.com',
  	"footer_text" varchar DEFAULT 'Independent thumbnail designer · Available worldwide',
  ...
  ALTER TABLE "work" ADD CONSTRAINT "work_channel_avatar_id_media_id_fk" FOREIGN KEY ("channel_avatar_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "work_channel_avatar_idx" ON "work" USING btree ("channel_avatar_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_applications_role";
  DROP TYPE "public"."enum_applications_service";
